...
-- ==  CUSTOM TYPES ==
--
CREATE TYPE mimetype AS ENUM ( -- replace slashes by underscores, slashed can cause probles e.g. in Hibernate and in other places
    'IMAGE_JPEG',
    'IMAGE_PNG',
    'IMAGE_TIFF'
);
...
CREATE TABLE IF NOT EXISTS input_data (
    id integer PRIMARY KEY,
    local_id integer NOT NULL,
    image_id integer NOT NULL UNIQUE REFERENCES image(id),
    analysis_id integer UNIQUE REFERENCES analysis(id)
);
